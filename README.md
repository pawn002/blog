...
## 11y Boilerplate README material
...
```
git clone https://github.com/11ty/pawn002-blog.git .
```
...
- Generated Pages
  ...
  - `sitemap.xml`
  - Zero-maintenance tag pages ([View on the Demo](https://pawn002-blog.netlify.app/tags/))
  - Content not found (404) page

### Demos

- [Netlify](https://pawn002-blog.netlify.app/)
- [Vercel](https://demo-base-blog.11ty.dev/)
- [Cloudflare Pages](https://pawn002-blog-d2a.pages.dev/)
- [Remix on Glitch](https://glitch.com/~11ty-pawn002-blog)
- [GitHub Pages](https://demo-base-blog.11ty.dev/)
...
- [Deploy this to **Netlify**](https://app.netlify.com/start/deploy?repository=https://github.com/11ty/pawn002-blog)
...
- [Try it out on **Stackblitz**](https://stackblitz.com/github/11ty/pawn002-blog)
